...
import {getBuilding, getPropertiesForBuilding, getRooms, getDepositPaymentDetails, getWalletDetails, changeDashboardView} from  '../actions/index'
import swal from 'sweetalert2'
require('../stylesheets/newPayment.css');
const currencyFormatter = require('currency-formatter');

class NewDepositPayment extends Component {
	...
	componentWillMount() {
		...
		let paymentDetails = this.props.getDepositPaymentDetails(JSON.parse(localStorage.activeBooking).id);
  ...
  render () {
  	let booking = JSON.parse(localStorage.activeBooking);
		      ...
		      <div className="container">
					  ...
					  <div className="payments-wrapper">
					    ...
					    <div className="col-md-6">
					      <div className="card">
					        <div className="card-header">
					          <h4 className="c-gray">Deposit Payment Details</h4><hr />
					        </div>
					        <div className="card-body card-padding">
			              ...
			              <dl className="dl-horizontal">
			                <dt>Monthly Rent</dt>
			                <dd className="price"> 
			                	{currencyFormatter.format(booking.rent, {code: 'INR'}).split('.')[0]}
			                </dd>
			              </dl>
			              <dl className="dl-horizontal">
...
export default connect( mapStateToProps, {getBuilding: getBuilding, getPropertiesForBuilding: getPropertiesForBuilding, getRooms: getRooms, getDepositPaymentDetails: getDepositPaymentDetails, getWalletDetails: getWalletDetails, changeDashboardView: changeDashboardView})(NewDepositPayment);
