...
import {getPropertiesForBuilding, getRooms, getRentPaymentDetails, getBooking, getBuilding, getWalletDetails} from  '../actions/index'
import swal from 'sweetalert2'
require('../stylesheets/newPayment.css');
const currencyFormatter = require('currency-formatter');

class NewRentPayment extends Component {

	componentWillMount() {
		let paymentDetails = this.props.getRentPaymentDetails(JSON.parse(localStorage.paymentObject).id);
  ...
  render () {
  	...
  	if(this.props.paymentDetails && booking)
	    return (
	    	<div>
	    		<WebHeader />
					      ...
					      <div className="card">
					        ...
					        <div className="card-body card-padding">
					          <dl className="dl-horizontal">
					            <dt>Booking ID</dt>
					            <dd>{this.props.paymentDetails.booking_id}</dd>
					          </dl>
			              <dl className="dl-horizontal">
			                <dt>Monthly Rent</dt>
			                <dd className="price"> ₹ 
...
export default connect( mapStateToProps, {getPropertiesForBuilding: getPropertiesForBuilding, getRooms: getRooms, getRentPaymentDetails: getRentPaymentDetails, getBooking: getBooking, getBuilding: getBuilding, getWalletDetails: getWalletDetails})(NewRentPayment);
